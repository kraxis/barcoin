...
static const int64 nTargetTimespan = 1 * 24 * 1 * 1; // BarCoin: 1 hr
static const int64 nTargetSpacing = 90; // BarCoin: 1.5 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf96393e6ceae21548b92fd00183b416caf8d62ad724c8f746bb7045b93ce625e");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1402787479; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1402787479;
            block.nNonce   = 3322055;
        }
